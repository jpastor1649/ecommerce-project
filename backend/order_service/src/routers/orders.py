...
from order_service.src.events.publisher import event_publisher as publisher
import logging
...
async def create_order_endpoint(
    ...
    order = await create_order(db, current_user.id, payload, _extract_token(request))

    # Publish ORDER_CREATED event in background to avoid blocking the async event loop
